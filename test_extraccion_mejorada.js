// Script para probar la extracción mejorada de diagnóstico
...
const casosPrueba = [
    {
        nombre: "Caso 1: Flexión de cadera + doblar piernas + rotar cuerpo",
...
console.log('🚀 PRUEBAS DE EXTRACCIÓN MEJORADA');
