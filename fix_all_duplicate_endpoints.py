#!/usr/bin/env python3
"""
Script para corregir todos los endpoints duplicados
"""


def fix_all_duplicate_endpoints():
    """Corrige todos los endpoints duplicados"""

    app_py_path = "app.py"

    print("🔧 Corrigiendo todos los endpoints duplicados...")
    ...
    print("✅ Todos los endpoints duplicados corregidos")
...
def main():
    ...
    if fix_all_duplicate_endpoints():
        ...
        if verify_no_duplicates():
            ...
            if verify_syntax():
                ...
                if test_server():
                    ...
                    print("\n🎉 ¡Todos los endpoints duplicados solucionados!")
        ...
        print("❌ No se pudieron corregir los endpoints")
