...
def debug_database_connection():
    ...
    print("🔍 Diagnosticando conexión a la base de datos...")
    ...
    # 2. Verificar si estamos en Railway o local
    print(f"\n2️⃣ Entorno de ejecución:")
    if database_url:
        print("   🚀 Detectado: Railway (con DATABASE_URL)")
    else:
        print("   💻 Detectado: Desarrollo local")

    # 3. Crear un script de prueba de conexión
    print("\n3️⃣ Creando script de prueba de conexión...")

    test_connection_script = '''#!/usr/bin/env python3
"""
...
'''
    ...
    with open("test_connection.py", "w", encoding="utf-8") as f:
        f.write(test_connection_script)

    print("✅ Script de prueba creado: test_connection.py")

    print("\n4️⃣ Próximos pasos:")
    print("   1. Ejecutar: python test_connection.py")
    print("   2. Revisar logs de Railway")
    print("   3. Verificar variables de entorno en Railway")
    print("   4. Comprobar que las tablas existen")
