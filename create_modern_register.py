#!/usr/bin/env python3
"""
Script para crear register moderno que coincida con el login
"""


def create_modern_register():
    """Crea register moderno que coincida con el login"""

    print("🎨 Creando register moderno...")

    # Template de register moderno
...
<body>
    ...
    # Escribir el nuevo register.html
    with open("templates/register.html", "w", encoding="utf-8") as f:
        f.write(register_html)

    print("✅ Register moderno creado")
    print("🎨 Características:")
    print("   - Diseño coincidente con login")
    print("   - Selector visual de tipo de usuario")
    print("   - Formulario optimizado")
    print("   - Colores y estilo consistentes")


if __name__ == "__main__":
    create_modern_register()
